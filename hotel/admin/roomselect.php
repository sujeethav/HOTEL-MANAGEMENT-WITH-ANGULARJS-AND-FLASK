    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php">allot room</a>
            </div>
<!--
       ...
       <!--
        <div id="page-wrapper" >
            ...
            <?php
						...
						$cat=$_POST['catroom'];
						$nbeds=$_POST['nbeds'];
						$sql = "select ROOM_NO from room where (CUSTOMER_ID is NULL and category='$cat' and NO_OF_BEDS=$nbeds) or ROOM_NO in(select ROOM_NO from room,reservation where gst_id=customer_id and (checkout_date<'$checkin' or checkin_date>'$checkout') and room.category='$cat' and NO_OF_BEDS=$nbeds)";
													...
													<div class='panel panel-primary text-center no-boder bg-color-blue'>
														<div class='panel-body'>
															<i class='fa fa-shield fa-5x'></i>
																	...
																	<input type='hidden' name='roomselect' value='".$row['ROOM_NO']."'/>
																	
																	<input type='submit' name='submit' class='btn btn-primary' value='".$row['ROOM_NO']."'>
